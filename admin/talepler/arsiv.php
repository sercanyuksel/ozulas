<?php
$sth=$conn->prepare("SELECT * from requests WHERE status=3 ORDER BY id DESC");
$sth->execute();
                ...
                <div class="row">
                    <div class="col-lg-12">
                            <div class="card">
                                ...
                                <button style="margin-left:5px;" id="filter_date1" class="btn btn-info p-2">Filtrele</button>
