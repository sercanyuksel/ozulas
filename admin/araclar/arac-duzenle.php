            ...
            <div class="card">
                ...
                <form METHOD="POST">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" name="code" value="<?=$car['code']?>" class="form-control" id="code">
                    </div>

                    <div class="form-group">
                        <label for="company">Bölge :</label>
                        <select name="area_id" class="form-control" id="code">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" name="license" value="<?=$car['license']?>" class="form-control" id="name" >
                    </div>

                    <div class="form-group">
                        <label for="company">m2m_gsm :</label>
                        <input type="text" name="m2m_gsm" value="<?=$car['m2m_gsm']?>" class="form-control" id="name" >
                    </div>

                    <div class="form-group">
                        <label for="company">m2m_ip :</label>
                        <input type="text" name="m2m_ip" value="<?=$car['m2m_ip']?>" class="form-control" id="name" >
                    </div>

                    <div class="form-group">
                        <label for="company">15gb gsm :</label>
                        <input type="text" name="gsm_15" value="<?=$car['15_gsm']?>" class="form-control" id="name" >
                    </div>

                    <div class="form-group">
                        <label for="company">15gb ip :</label>
                        <input type="text" name="ip_15" value="<?=$car['15_ip']?>" class="form-control" id="name" >
                    </div>

                    <div class="form-group">
                        <label for="company">Hdd :</label>
                        <input type="text" name="hdd" value="<?=$car['hdd']?>" class="form-control" id="name" >
                    </div>

                    <div class="form-group">
                        <label for="company">Kayıt Süre :</label>
                        <input type="text" name="kayit_sure" value="<?=$car['kayit_sure']?>" class="form-control" id="name" >
                    </div>

                    <div class="form-group">
                        <label for="company">Dvr :</label>
                        <input type="text" name="dvr" value="<?=$car['dvr']?>" class="form-control" id="name" >
                    </div>
