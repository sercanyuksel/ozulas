            ...
            <div class="card">
                ...
                <form method="POST" id="frm" action="">
                    ...
                    <div class="form-group">
                        ...
                        <select multiple disabled class="form-control" name="camss" id="result"> 
                    ...
                    <div class="row">
                        <div class="col-6">
                            <button id="close" type="button"  class="btn btn-danger px-4" <?php if($request['status']!=2) {echo 'disabled title="Henüz Cevaplanmamış"';}?>>Kapat</button>
                        </div>
                    </div>
