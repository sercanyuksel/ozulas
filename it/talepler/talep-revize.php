            ...
            <div class="card">
                ...
                <form method="POST" id="frm" action="">
                    ...
                    <div class="form-group">
                        ...
                        <select multiple  class="form-control" name="camera[]" id="camss"> 
                    ...
                    <div class="form-group">
                        ...
                        <input type="time"  name="s_time" value="<?=$request['start_time']?>" />                        
                    </div>

                    <div class="form-group">
                        <label for="company">Bitiş Saati :</label>
                        <input type="time"  name="e_time" value="<?=$request['stop_time']?>" />                        
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <textarea  rows="4" name="desc" class="form-control" id="desc"><?=$request['description']?></textarea>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <select disabled class="form-control" name="result" id="result"> 
