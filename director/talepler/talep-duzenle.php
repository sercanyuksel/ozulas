        ...
        <div class="col-sm-12   ">
            ...
            <div class="card">
                ...
                <form method="POST">
                    ...
                    <div class="form-group">
                        <label for="company">Rapor Tarihi :</label>
                    ...
                    <div class="form-group">
                        ...
                        <select disabled <?php if($request['status']==2)echo'disabled'; ?> class="form-control" name="result" id="result"> 
                    ...
                    <div class="form-group">
                        ...
                        <textarea  disabled rows="4" <?php if($request['status']==2)echo'disabled'; ?>  name="resp" class="form-control" id="desc"><?=$request['response']?></textarea>
                    </div>

                    <?php if($request['status']==2||$request['status']==3){ 
                        $sth=$conn->prepare("SELECT * from request_files WHERE talep_id=?");
                        $sth->execute(array(
                            $request['id']
                        ));
                        ...
                        ?>
                    <div class="form-group">
                        <label for="desc">Dosyalar :</label>
                        <i class="icon-folder"></i> <a href="../../uploads/<?=$file?>" download><?=$file?></a>
                    </div>
                    <?php } ?>
