            ...
            <div class="card">
                ...
                <div class="form-group">
                    ...
                    <div class="form-group">
                        ...
                        <input disabled <?php if($mudahale) echo 'readonly value="'.$car_trouble['mudahale_yeri'].'"' ?> type="text" name="mudahale_yeri" class="form-control col-sm-12 col-md-6" id="company"  placeholder="Müdahale Yeri">
                    </div>

                    <div class="form-group">
                        <label for="company">Müdahale Saati :</label>
                        <input disabled <?php if($mudahale_saati) echo 'readonly value="'.$car_trouble['mudahale_saati'].'"' ?> type="time" name="mudahale_saati" class="form-control col-sm-12 col-md-6" id="company"  >
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <select disabled <?php if($mesai) echo 'disabled'; ?> name="mesai">
                    ...
                    <div class="form-group">
                        ...
                        <textarea disabled <?php if($sonuc) echo'readonly'; ?> name="sonuc" class="form-control col-sm-12 col-md-6" id="company"  rows="4"><?php if($sonuc) echo $car_trouble['sonuc']; ?></textarea>
                    </div>
